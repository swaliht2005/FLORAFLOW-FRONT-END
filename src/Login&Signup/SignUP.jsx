...
//             if (response.ok) {
//                 console.log("Registration successful:", responseData);
//                 localStorage.setItem('token', responseData.token); // Store token for authentication
//                 navigate("/login");
//             } else {
//                 console.log("Error response:", responseData);
//                 setError(responseData.error || "Failed to register. Please try again.");
//             }
//         } catch (err) {
...
//                     <div className="flex flex-col gap-2">
//                         <button
//                             className="w-full bg-blue-600 text-white py-2 px-4 rounded-md shadow hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 disabled:bg-blue-400"
//                             type="submit"
//                             disabled={loading}
//                         >
